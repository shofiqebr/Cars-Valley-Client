...
const Recomended = () => {
    ...
    return (
        <section>
             <SectionTitle heading={'Our Car Recommendations'} subHeading={'Check it out'}></SectionTitle>
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-center items-center gap-10 ml-5 md:ml-1 my-5">
                    {
